...
class UserRoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        try {
            ...
            // 1. Buat Super Admin
            User::create(['name' => 'Super Admin', 'email' => 'sua@gmail.com', 'password' => bcrypt('123'), 'role' => 'super_admin'])
                ->staff()->create(['unit_id' => $unitTikId, 'jabatan_id' => $jabatanSuperAdminId, 'nik' => '11111']);

            // 2. Buat Kepala Unit
            $kepalaUnitUser = User::create(['name' => 'Kepala Unit TIK', 'email' => 'kepala@gmail.com', 'password' => bcrypt('123'), 'role' => 'kepala_unit']);
            ...
            // 3. Buat Admin Unit
            User::create(['name' => 'Admin Unit TIK', 'email' => 'admin@gmail.com', 'password' => bcrypt('123'), 'role' => 'admin_unit'])
                ->staff()->create(['unit_id' => $unitTikId, 'jabatan_id' => $jabatanStaffId, 'nik' => '33333']);

            // 4. Buat Staff Layanan untuk Unit UPA TIK
            User::create(['name' => 'Staff UPA TIK', 'email' => 'staff.tik@gmail.com', 'password' => bcrypt('123'), 'role' => 'admin_unit'])
                ->staff()->create(['unit_id' => $unitTikId, 'jabatan_id' => $jabatanStaffId, 'nik' => '44444']);

            // 5. Buat Staff Layanan untuk Unit Akademik
            User::create(['name' => 'Staff Akademik', 'email' => 'staff.akademik@gmail.com', 'password' => bcrypt('123'), 'role' => 'admin_unit'])
                ->staff()->create(['unit_id' => $unitAkademikId, 'jabatan_id' => $jabatanStaffId, 'nik' => '55555']);

            // 6. Buat Staff Layanan untuk Unit Kemahasiswaan
            User::create(['name' => 'Staff Kemahasiswaan', 'email' => 'staff.kemahasiswaan@gmail.com', 'password' => bcrypt('123'), 'role' => 'admin_unit'])
            ...
            User::create(['name' => 'Budi Santoso', 'email' => 'budi.s@example.com', 'password' => bcrypt('123'), 'role' => 'admin_unit'])
