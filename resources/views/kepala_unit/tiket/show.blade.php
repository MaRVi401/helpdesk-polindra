...
@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Kepala Unit /</span> Detail Tiket
</h4>
...
<div class="row">
  ...
  <div class="col-md-8 col-lg-9">
    ...
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('kepala_unit.dashboard') }}" class="btn btn-sm btn-secondary">Kembali ke Dashboard</a>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            ...
            <p class="mb-2"><strong>Layanan:</strong> {{ $tiket->layanan->nama_layanan }}</p>
          </div>
          <div class="col-md-6">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('kepala_unit.tiket.storeKomentar', $tiket->id) }}" method="POST">
          @csrf
          <div class="mb-3">
  ...
  <div class="col-md-4 col-lg-3">
    <div class="card">
      ...
      <div class="card-body">
        <form action="{{ route('kepala_unit.tiket.update', $tiket->id) }}" method="POST">
          @csrf
          @method('PUT')
          <div class="mb-3">
