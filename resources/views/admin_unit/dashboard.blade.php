      ...
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            ...
            <p class="mb-4">Anda login sebagai Admin Unit. Anda dapat melihat dan mengelola semua tiket yang masuk.</p>
            <a href="{{ route('admin_unit.layanan.index') }}" class="btn btn-sm btn-outline-primary">Kelola Layanan Unit</a>
          </div>
        </div>
  ...
  <div class="col-12 mb-4">
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{ route('admin_unit.dashboard') }}" method="GET">
          <div class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-3 d-flex align-items-end">
              ...
              <a href="{{ route('admin_unit.dashboard') }}" class="btn btn-secondary">Reset</a>
            </div>
          </div>
        </form>
      </div>
        ...
        <table class="table table-hover">
          ...
          <tbody class="table-border-bottom-0">
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('admin_unit.tiket.show', $tkt->id) }}" class="btn btn-sm btn-primary">Detail</a>
              </td>
            </tr>
            @empty
            <tr>
