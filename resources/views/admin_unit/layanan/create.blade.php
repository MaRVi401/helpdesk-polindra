...
@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Admin Unit / Kelola Layanan /</span> Tambah Layanan
</h4>

<div class="row">
  <div class="col-md-12">
    <div class="card mb-4">
      <h5 class="card-header">Formulir Layanan Baru</h5>
      <div class="card-body">
        <form action="{{ route('admin_unit.layanan.store') }}" method="POST">
          @csrf
