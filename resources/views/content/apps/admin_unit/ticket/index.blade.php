    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        @if (isset($isPic) && $isPic === false)
            <div class="alert alert-danger d-flex align-items-center" role="alert">
                ...
                <div>
                    <strong>Akses Terbatas!</strong> Akun Anda belum diatur sebagai PIC untuk Layanan manapun. Silakan
                    hubungi Kepala Unit.
                </div>
            </div>
        @else
                            ...
                            <tbody>
                                @forelse($layanan->tiket as $tiket)
                                    <tr>
                                        ...
                                        <td>
                                            @php
                                                $st = $tiket->statusTerbaru?->status ?? 'Diajukan Oleh Pemohon';
                                                $cssClass = 'status-' . str_replace(' ', '_', strtolower($st));
                                            @endphp
