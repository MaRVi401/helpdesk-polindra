...
@section('content')
    <style>
        /* --- CSS Warna Status (Sesuai Skema Konsisten) --- */
        .status-badge {
            padding: 5px 10px;
            border-radius: 6px;
            font-size: 0.75rem;
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        @if (isset($isPic) && $isPic === false)
            <div class="alert alert-danger d-flex align-items-center" role="alert">
                ...
                <div>
                    <strong>Akses Terbatas!</strong> Akun Anda belum diatur sebagai PIC.
                </div>
            </div>
        @else
            {{-- Filter Global --}}
                            ...
                            <div class="col-md-5">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="q" class="form-control"
                                        placeholder="Cari No Tiket / Nama Pemohon..." value="{{ request('q') }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                @forelse($layanan->tiket as $tiket)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {{-- Menggunakan $baseRoute untuk action --}}
                                            <a href="{{ route($baseRoute . 'edit', $tiket->id) }}"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center py-4 text-muted">
                                            ...
                                            Tidak ada tiket ditemukan untuk layanan ini dengan filter saat ini.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
            ...
            @empty
                <div class="alert alert-info text-center p-5">
                    ...
                    <h5>Belum ada data Layanan atau tidak ada tiket yang sesuai filter.</h5>
                    <p>Pastikan Anda tidak memiliki filter pencarian atau status yang terlalu ketat.</p>
                </div>
            @endforelse
        @endif
    </div>
