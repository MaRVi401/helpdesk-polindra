...
@section('content')
    ...
    <div class="row">
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <p><small class="text-muted">NIM:
                                <strong>{{ $tiket->pemohon->mahasiswa->nim ?? '-' }}</strong></small></p>
                    </div>
                        ...
                        <div class="p-3 border rounded bg-label-secondary">
                            ...
                            @if (str_contains($tiket->layanan->nama, 'Reset Akun'))
                                <dl class="row mb-0">
                                    ...
                                    <dd class="col-sm-8">
                                        <span
                                            class="badge bg-label-info">{{ strtoupper($detailLayanan->aplikasi ?? '-') }}</span>
                                    </dd>
                            ...
                            <li class="timeline-item timeline-item-transparent">
                                ...
                                <div class="timeline-event">
                                    <div class="timeline-header">
                                        ...
                                        <span
                                            class="status-badge {{ $historyClass }}">{{ str_replace('_', ' ', $historyStatus) }}</span>
                                        <small class="text-muted">{{ $riwayat->created_at->format('d M Y H:i') }}</small>
                                    </div>
                                    <p class="mb-0">
                                        Oleh: <strong>{{ $riwayat->user->name ?? 'Sistem' }}</strong>
                                        <span
                                            class="badge bg-label-secondary">{{ $riwayat->user->role ?? 'Sistem' }}</span>
                                    </p>
                                </div>
                            </li>
                        @empty
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('ticket.update', $tiket) }}">
                        ...
                        <button type="submit" name="action" value="update_status" class="btn btn-primary w-100">Simpan
                            Status</button>
                    </form>
                </div>
            </div>
            ...
            <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('ticket.update', $tiket) }}">
                        ...
                        <button type="submit" name="action" value="add_comment" class="btn btn-secondary w-100">Kirim
                            Komentar</button>
                    </form>
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <a href="{{ route('ticket.index') }}" class="btn btn-secondary w-100">
