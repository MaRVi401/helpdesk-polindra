        ...
        <div class="ticket-layout">
            <div class="ticket-main">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('service.ticket.comment', $tiket->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <a href="{{ route('service-ticket.index') }}" class="button button-secondary" style="float: right;">Kembali ke Daftar</a>
                        </form>
                    </div>
                </div>
                @else
