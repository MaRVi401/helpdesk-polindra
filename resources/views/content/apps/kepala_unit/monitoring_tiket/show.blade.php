        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12">
                    ...
                    <div class="card-body">
                        ...
                        @if (!$canEdit)
                            <div class="alert alert-warning d-flex align-items-center mb-4" role="alert">
                                ...
                                <div>
                                    Menu Terkunci: Aksi hanya dapat dilakukan saat status tiket adalah "Pemohon Bermasalah"
                                    dan membutuhkan validasi Anda.
                                </div>
                            </div>
                        @endif
                        ...
                        <form action="{{ route('kepala-unit.monitoring.update', $tiket->id) }}" method="POST">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    @if ($canEdit)
                                        <div class="form-text text-primary">Silakan validasi tiket ini untuk penyelesaian
                                            akhir.</div>
                                    @else
                                        <div class="form-text text-danger">Status saat ini:
                                            "{{ str_replace('_', ' ', $currentStatus) }}". Tidak ada tindakan yang
                                            diperlukan dari Kepala Unit.</div>
                                    @endif
                                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        {{-- Form Komentar --}}
                        <form action="{{ route('kepala-unit.monitoring.komentar', $tiket->id) }}" method="POST"
                            class="mb-5">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label fw-bold">Balas / Tambah Catatan Anda</label>
                                <textarea name="komentar" class="form-control" rows="3"
                                    placeholder="Tulis pesan untuk pemohon atau catatan internal..." required></textarea>
                            </div>
                            <div class="text-end">
                            ...
                            @foreach ($tiket->riwayatStatus->sortByDesc('created_at') as $riwayat)
                                @php
                                    ...
                                    if (str_contains($statusLower, 'diajukan')) {
                                        ...
                                        str_contains($statusLower, 'ditangani') ||
                                        str_contains($statusLower, 'diselesaikan')
                                    ) {
                                        $dotColor = '#f6ad55';
                                    } elseif (
                                        str_contains($statusLower, 'belum_selesai') ||
                                        str_contains($statusLower, 'bermasalah') ||
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        <div class="timeline-title">
                                            ...
                                            <span class="status-badge"
                                                style="background-color: {{ $dotColor }}; color: white; text-transform: capitalize;">
            ...
            <div class="col-lg-4 col-md-12">
                        ...
                        <dl class="row mb-0">
                            ...
                            <dd class="col-sm-8 mt-2 text-end">
                                @php
                                    ...
                                    if ($prioVal == 3) {
                                        $prioLabelShow = 'Tinggi';
                                        $prioClassShow = 'prioritas-tinggi';
                                    } elseif ($prioVal == 2) {
                                        $prioLabelShow = 'Sedang';
                                        $prioClassShow = 'prioritas-sedang';
                                    } elseif ($prioVal == 1) {
                                        $prioLabelShow = 'Rendah';
                                        $prioClassShow = 'prioritas-rendah';
                                    }
                                @endphp
                    ...
                    <div class="card mb-4 border border-warning shadow-sm">
                        ...
                        <div class="card-body pt-3 text-center">
                            ...
                            <div class="collapse" id="settingTimer">
                                <form action="{{ route('kepala-unit.monitoring.update-timer', $tiket->id) }}"
                                    method="POST" class="bg-light p-2 rounded border">
                                    @csrf
                                    @method('PUT')
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            var x = setInterval(function() {
                                ...
                                document.getElementById("admin-countdown").innerHTML =
                                    (days > 0 ? days + "h " : "") + pad(hours) + "j " + pad(minutes) + "m " + pad(seconds) +
                                    "d";

                                if (distance < 0) {
                                    clearInterval(x);
                                    document.getElementById("admin-countdown").innerHTML =
                                        "Waktu Habis. Memproses status...";
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <a href="{{ route('kepala-unit.monitoring.index') }}" class="btn btn-secondary w-100">
